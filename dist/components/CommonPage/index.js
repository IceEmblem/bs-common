...
var BaseCommonPage = /*#__PURE__*/function (_React$Component) {
  _inherits(BaseCommonPage, _React$Component);
  var _super = _createSuper(BaseCommonPage);
  function BaseCommonPage() {
    var _this;
    _classCallCheck(this, BaseCommonPage);
      ...
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(page, pageSize, filter, sorter) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              sortField = (sorter === null || sorter === void 0 ? void 0 : sorter.field) || _this.props.state.sortField;
              sortDirection = ((sorter === null || sorter === void 0 ? void 0 : sorter.order) == 'ascend' ? 'asc' : (sorter === null || sorter === void 0 ? void 0 : sorter.order) == 'descend' ? 'desc' : undefined) || _this.props.state.sortDirection;
              _this.setState({
                loading: true
              });
              _context.next = 6;
              return _this.props.dispatch(_this.props.slice.asyncActions.fetchPageDatas({
                page: page || _this.props.state.page,
                pageSize: pageSize || _this.props.state.pageSize,
                filter: filter || _this.props.state.filter,
                sortField: sortField,
...
var CommonPage = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  var state = (0, _reactRedux.useSelector)(function (state) {
    return state[props.slice.name];
  });
  var dispatch = (0, _reactRedux.useDispatch)();
  return /*#__PURE__*/_react["default"].createElement(BaseCommonPage, _extends({
    ref: ref,
    state: state,
    dispatch: dispatch
  }, props));
