...
exports["default"] = exports.bsFetchCallBack = void 0;
...
var StatusError = /*#__PURE__*/function (_Error) {
  ...
  return _createClass(StatusError);
}( /*#__PURE__*/_wrapNativeSuper(Error));
function bsFetch(_x, _x2) {
  return _bsFetch.apply(this, arguments);
}
function _bsFetch() {
  _bsFetch = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(input, init) {
    var newInit, response, _error, _error2, data, _error3, error;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          newInit = _objectSpread({}, init);
          if (!newInit.headers) {
            newInit.headers = {
          ...
          if (_token["default"].token) {
            newInit.headers['Authorization'] = "Bearer ".concat(_token["default"].token);
          }
          _context2.next = 5;
        ...
        case 12:
          ...
          _error = new StatusError('401 Authentication failed', response.status);
          throw _error;
        case 15:
          ...
          _error2 = new StatusError('404 Resource not found', response.status);
          throw _error2;
        case 18:
        ...
        case 21:
          data = _context2.sent;
          _error3 = new StatusError("".concat(data['hydra:description'] || 'unknown exception'), response.status);
          throw _error3;
        case 24:
          error = new StatusError("".concat(response.status, " ").concat(response.statusText), response.status);
          throw error;
        case 26:
        case "end":
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(input, init) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          fetchSign++;
          curFetchSign = fetchSign;
          _context.prev = 2;
          bsFetchCallBack.befores.forEach(function (fun) {
            fun({
              input: input,
              init: init,
        ...
        case 13:
          ...
          bsFetchCallBack.catchs.forEach(function (fun) {
            fun({
              input: input,
              init: init,
              ex: _context.t0,
...
exports.bsFetchCallBack = bsFetchCallBack;
var _default = bsFetchEx;
